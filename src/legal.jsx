...
const pages = {
  ...
  '/datenschutz': { title: 'Datenschutzerklärung', intro: 'Informationen nach Art. 13 und 14 Datenschutz-Grundverordnung (DSGVO)', sections: [
    ...
    ['Kontaktaufnahme und Anfrageformular', <>Wenn Sie uns per E-Mail oder über das Anfrageformular kontaktieren, verarbeiten wir Ihre Angaben, um Ihre Anfrage zu beantworten. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO bei vorvertraglichen oder vertraglichen Anfragen, ansonsten Art. 6 Abs. 1 lit. f DSGVO. Zur technischen Übermittlung des Formulars nutzen wir FormSubmit. Die Formulardaten werden dort verarbeitet, per E-Mail an uns übermittelt und laut Anbieter bis zu 30 Tage vorgehalten. Eine Kopie der Anfrage geht an info@lwscaling.com. Wir löschen die Daten, sobald die Anfrage erledigt ist und keine gesetzlichen Aufbewahrungspflichten entgegenstehen.</>],
    ['Spam- und Missbrauchsschutz', <>Das Anfrageformular verwendet Cloudflare Turnstile. Dabei werden technisch erforderliche Verbindungs- und Gerätedaten verarbeitet, um automatisierte oder missbräuchliche Anfragen zu erkennen. Die Verarbeitung dient der Sicherheit des Formulars auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.</>],
